...
public class CartorioController {
	...
	@RequestMapping(value = "/cartorio/editar", method = RequestMethod.GET)
	public String update(@ModelAttribute Long id, Model model) {
		model.addAttribute("cartorio", cartorioService.getCartorio(id));
		return "update";
	}
	
	@RequestMapping(value = "/cartorio/salvar", method = RequestMethod.POST)
	public String salvarUpdate() {
		System.out.println("stop");
		return "browser";
	}
	
	@RequestMapping(value = "/deletar", method = RequestMethod.DELETE)
	public String delete(@ModelAttribute Long id, Model model) {
